...
const ITEM_SIZE = wp(16); // Icon size
const ITEM_MARGIN = wp(1.7); // Margin between icons

const Game5x5Screen = ({navigation}: NavProps) => {
  const [icons, setIcons] = useState<Icon[][]>(initialIcons5x5);
