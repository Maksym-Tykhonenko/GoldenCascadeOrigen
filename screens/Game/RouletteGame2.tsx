...
import {loadPoints, NavProps, rouleteProps2} from '../../services/GameService';

export const RouletteGame2 = ({navigation}: NavProps) => {
    ...
    <>
      <View style={styles.container}>
        ...
        <ImageBackground
          ...
          <RouletteLogic navigation={navigation} images={rouleteProps2} />
        </ImageBackground>
      </View>
